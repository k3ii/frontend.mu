...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Dodo Dodge is a simple runner game (à la Super Mario Bros.) where you play as a dodo bird and either dodge hunters or stomp on them.'
  },
  {
  ...
  },
  {
    ...
    description: 'A cross-platform mobile app for navigating Mauritius by bus (and soon via the metro too!) based on public transport data and user contributions to OpenStreetMaps.'
  },
  {
    title: 'Animal breeds search',
    icon: 'maki:dog-park-11',
    project_url: 'https://github.com/mahima98/animal-breeds',
    author_github_username: 'animal-breeds',
